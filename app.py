...
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', "sh")
...
def register():
    """Register a user: form and handle form submission."""
...
def show_user(username):
    ...
    return render_template("users/show_feedback.html", user=user, form=form)
